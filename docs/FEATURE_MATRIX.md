...
| --- | --- | --- | --- | --- |
| D01 | Локальная лента, просмотр фото/видео, альбомы | Собственная реализация; идеи Lavender + Fossify | **Частично реализовано:** MediaStore без копирования, Google Share-копии, пятиуровневая лента и просмотр фото | Видео, папки и альбомы вне MVP; внутренний Fold ещё не принят |
