...
| D07 | Люди: группы, имена и исправление ошибок | Ente + ReFra | **Реализовано в Task 11:** YuNet/SFace в isolated CPU runtime, поколения detections/embeddings и отдельные durable имена/merge/split/move/exclude решения; экран «Люди» EN/RU | Качество кластеров и порог ещё требуют размеченной физической приёмки |
