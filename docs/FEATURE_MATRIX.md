...
| --- | --- | --- | --- | --- |
| D01 | Локальная лента, просмотр фото/видео, альбомы | Собственная реализация; идеи Lavender + Fossify | **Частично реализовано:** MediaStore без копирования, Google Share-копии, пятиуровневая Room/Paging-лента, SQL-агрегаты периодов и максимум три обложки, viewer с соседями по ID; отменяемое сканирование пакетами и ContentObserver | Видео, папки и альбомы вне MVP; внутренний Fold ещё не принят |
