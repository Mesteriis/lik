...
Пользователь выбрал верхнюю панель с облаком и настройками, мозаику дней, нижнюю навигацию и масштабирование «Фото → Дни → Недели → Месяцы → Годы». Группировка использует дату съёмки, при её отсутствии — дату добавления. Для обзорных уровней приняты обложки и счётчики; при раскрытии Fold сохраняются масштаб и место в библиотеке.
