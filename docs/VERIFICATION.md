...
- `./gradlew lint testDebugUnitTest assembleDebug assembleRelease assembleDebugAndroidTest` — PASS; **112 JVM tests**, zero failures/errors/skips, lint and release shrink passed. `LIK_MODEL_CACHE=/tmp/lik-nonexistent-model-cache ./gradlew assembleDistribution` also passed; all three APK payload gates reported zero ONNX and tokenizer payloads.
- Clean compiler-only `--no-build-cache` rebuild and `compiled_apk.py` candidate — PASS; the final candidate is byte-identical to the checked-in receipt. Reviewed policy SHA-256 `6d74a1f34496fcc13c4724522999eadb92b99ae57c2af9c1f890a65f314e25ef`, source fingerprint `a908a392c32941b7cf968a6f8fc16773b3ba35164b4c3c816219b71c26cdb3f7`. Catalog v3 SHA-256 is `0ae75601e4ca4bcdef037dc592d25601d29a6e66e5df0d4238d2433b01c632f6`. The native-content policy SHA-256 is `610ed7cb453739112d06b9a60b371159eac32cea2ed392e36734900161d323ec`.
...
- `ANDROID_SERIAL=emulator-5580 ./gradlew connectedDebugAndroidTest` — PASS in 1m58s; **114 runner tests, zero failures/errors, 6 expected external-model/network skips**. The exact-boundary regression performs the admitted transfer, journal, ledger, catalog and receipt writes with late file allocation disabled; the related rounding regression verifies that two one-byte transfers plus a one-byte safety margin require three distinct filesystem allocation units. AVD `lik_api37_qa`, API 37, arm64, 16-KiB page configuration.
...
| --- | ---: | --- | ---: | ---: | ---: |
| Debug | 60,666,407 | `acd0a3fe458ace4ac8ded2ae56ab0fd975cafaa01470b42c2b9d6f014db8b0f5` | 60,613,084 | 60,920,939 | 158 |
| Release unsigned | 48,336,148 | `11518d7e8aa01c3c8cbd2ec7671f5829219d5ad44b2b7c0fa72fa8dcb298f329` | 48,299,383 | 48,604,910 | 117 |
| Debug androidTest | 1,331,363 | `7d3d5f4fd09d1199bc482a7e7180f0547f6e28d2164ff1d9264e32738501039d` | 1,318,820 | 1,424,928 | 52 |
