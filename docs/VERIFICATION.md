...
- Clean compiler-only `--no-build-cache` rebuild and `compiled_apk.py` candidate — PASS; the final candidate is byte-identical to the checked-in receipt. Reviewed policy SHA-256 `0173da8cebe02c40f4826ede09790c553a163905e2a0b3d99719bff6025006c1`, source fingerprint `62384931c8e125b0c7f9a010cc051e49509645a897fb2c7086f43504439f323a`. The native-content policy SHA-256 is `610ed7cb453739112d06b9a60b371159eac32cea2ed392e36734900161d323ec`.
- External private-model acceptance on `emulator-5580` — PASS. One combined run covered all three real image/Russian-text profile self-tests, persistent runtime reuse/death/rebind, clean Room generation/native USearch publication and verified-staging recovery (**4/4**, 16.396 seconds). A separate all-component reference run covered all 12 ONNX graphs and compared their actual outputs with the externally cached pinned references (**1/1**, 5.608 seconds), and a real immutable-HF ranged resume passed (**1/1**, 4.756 seconds). The 29 files / 3,663,983,902 bytes were provisioned only into emulator app-private storage and never into an APK.
- `ANDROID_SERIAL=emulator-5580 ./gradlew connectedDebugAndroidTest` — PASS in 1m59s; XML **106 tests, zero failures/errors, 6 expected external-model/network skips** (Gradle runner footer reported 112). AVD `lik_api37_qa`, API 37, arm64, 16-KiB page configuration.
- `LIK_MODEL_CACHE=... venv/bin/python -m unittest discover -s scripts/models/tests -p 'test_*.py'` — **46 tests, zero failures/skips**, 14.842 seconds.
...
| --- | ---: | --- | ---: | ---: | ---: |
| Debug | 60,605,347 | `618243caaf76845744ca44a79a331217760d9f1c4b51062f57fb12e310492d5a` | 60,555,767 | 60,785,943 | 158 |
| Release unsigned | 48,326,188 | `dc22de660e8f31274c0de869be22fff7f871504dda5b6402b972f9393d33d5f7` | 48,278,010 | 48,503,910 | 117 |
| Debug androidTest | 1,324,307 | `79f7e625dd6cecc7da87b3e90e2bd5806e1611c16a50eba36ad2cf9812563d17` | 1,311,764 | 1,417,872 | 52 |
