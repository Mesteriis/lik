...
- `./gradlew lint testDebugUnitTest assembleDebug assembleRelease assembleDebugAndroidTest` — PASS; **106 JVM tests**, zero failures/errors/skips, lint and release shrink passed. `LIK_MODEL_CACHE=/tmp/lik-nonexistent-model-cache ./gradlew assembleDistribution` also passed; all three APK payload gates reported zero ONNX and tokenizer payloads.
- Clean compiler-only `--no-build-cache` rebuild and `compiled_apk.py` candidate — PASS; the final candidate is byte-identical to the checked-in receipt. Reviewed policy SHA-256 `dbac4487bb65d6c70ed586c55105d1331c1947127ef5588fbc6ca208fda6dc03`, source fingerprint `c74fe14cd80c785c49cfa6848c3f9d4bd20c9c9dd61e7a9e628f09f5b7416263`. The native-content policy SHA-256 is `610ed7cb453739112d06b9a60b371159eac32cea2ed392e36734900161d323ec`.
- External private-model acceptance on `emulator-5580` — PASS. One combined run covered all three real image/Russian-text profile self-tests, persistent runtime reuse/death/rebind, clean Room generation/native USearch publication and verified-staging recovery (**4/4**, 17.597 seconds). A separate all-component reference run covered all 12 ONNX graphs (**1/1**, 5.631 seconds), and a real immutable-HF ranged resume passed (**1/1**, 4.034 seconds). The 29 files / 3,663,983,902 bytes were provisioned only into emulator app-private storage and never into an APK.
- `ANDROID_SERIAL=emulator-5580 ./gradlew connectedDebugAndroidTest` — PASS; runner footer **110 tests, zero failures/errors, 6 expected external-model/network skips**. AVD `lik_api37_qa`, API 37, arm64, 16-KiB page configuration.
- `LIK_MODEL_CACHE=... venv/bin/python -m unittest discover -s scripts/models/tests -p 'test_*.py'` — **46 tests, zero failures/skips**, 13.742 seconds.
...
| --- | ---: | --- | ---: | ---: | ---: |
| Debug | 60,588,963 | `a7478f4afa218b879786064ad9f5bf6784b31c6de6115390dba2bbb1aea8f2da` | 60,538,371 | 60,768,547 | 158 |
| Release unsigned | 48,309,804 | `81b5badc3ee8f327c4ddecdfe8313e7e2b544dd0985af37a5773ba7d1f86d7c4` | 48,270,782 | 48,496,682 | 117 |
| Debug androidTest | 1,320,363 | `d39bd5703f7a39af210bee30b0c8c1fef5a45618af5f634946ef7dfe8259e57c` | 1,307,820 | 1,413,928 | 52 |
