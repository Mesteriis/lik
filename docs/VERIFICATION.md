...
- Проверка реального облачного фото остаётся пользовательским шагом на открытом Fold.
...
- Физическая проверка внутреннего экрана отложена до раскрытия устройства, а проверка реального обновлённого Fold — до появления Android 17 на устройстве. API 37 покрыт эмулятором и тем же APK-кодом без отдельной ветки совместимости.
