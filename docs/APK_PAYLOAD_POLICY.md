...
ZIP prefix/trailer/comment/extra-field payloads, duplicate or overlapping entries, hidden deflate bodies and unreferenced nonzero data are rejected. Empty alignment and Zipflinger deleted-entry padding are allowed only when their complete contents are zero. Compressed physical and total uncompressed APK sizes remain limited to 250 MiB.
