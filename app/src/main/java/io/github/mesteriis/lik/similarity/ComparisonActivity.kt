...
class ComparisonActivity:Activity(){
    ...
    private var shown:ComparisonPair?=null
    private val invalidation=object:InvalidationTracker.Observer("media","ai_media_exposure","content_fingerprint","fingerprint_failure","fingerprint_band","similarity_relation","similarity_scan","similarity_checkpoint"){
        override fun onInvalidated(tables:Set<String>){runOnUiThread{if(!isDestroyed){unavailable();load()}}}
    }
    ...
    private fun unavailable(){request++;shown=null;clearImages();findViewById<TextView>(R.id.comparison_reason).text="";findViewById<TextView>(R.id.comparison_left_details).text="";findViewById<TextView>(R.id.comparison_right_details).text="";findViewById<View>(R.id.comparison_left_delete).visibility=View.GONE;findViewById<View>(R.id.comparison_right_delete).visibility=View.GONE;findViewById<View>(R.id.comparison_content).visibility=View.GONE;findViewById<View>(R.id.comparison_unavailable).visibility=View.VISIBLE}
