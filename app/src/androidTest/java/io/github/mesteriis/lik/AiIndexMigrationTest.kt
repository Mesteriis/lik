...
class AiIndexMigrationTest {
    @Test fun versionFourUpgradePreservesOrganizationAndCreatesAiGenerationStore() {
        ...
        try {
            ...
            val db = Room.databaseBuilder(context, MediaDatabase::class.java, name)
                .addMigrations(MediaDatabase.MIGRATION_4_5, MediaDatabase.MIGRATION_5_6, MediaDatabase.MIGRATION_6_7, MediaDatabase.MIGRATION_7_8, MediaDatabase.MIGRATION_8_9, MediaDatabase.MIGRATION_9_10, MediaDatabase.MIGRATION_10_11).build()
            try {
    ...
    @Test fun versionFiveUpgradeUsesStableGrantEpochForExistingEmbeddings() {
        ...
        try {
            ...
            val db = Room.databaseBuilder(context, MediaDatabase::class.java, name).addMigrations(MediaDatabase.MIGRATION_5_6, MediaDatabase.MIGRATION_6_7, MediaDatabase.MIGRATION_7_8, MediaDatabase.MIGRATION_8_9, MediaDatabase.MIGRATION_9_10, MediaDatabase.MIGRATION_10_11).build()
            try {
