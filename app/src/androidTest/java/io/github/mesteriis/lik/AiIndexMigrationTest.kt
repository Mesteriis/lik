    ...
    @Test fun versionFiveUpgradeUsesStableGrantEpochForExistingEmbeddings() {
        ...
        try {
            ...
            try {
                ...
                db.ocrPeople().saveExposure(io.github.mesteriis.lik.ai.AiMediaExposureRecord("m",7,io.github.mesteriis.lik.ai.AiExposure.SAFE,2))
