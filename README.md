...
Android-галерея с локальным искусственным интеллектом. Реализованы прямой просмотр разрешённой локальной медиатеки через MediaStore, ручной импорт «Google Photos → Поделиться → Лик», скачиваемые профили Compact/Balanced/Extended и семантический поиск по RU/EN-запросам.
