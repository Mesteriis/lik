...
| [Постоянный каталог](docs/MEDIA_CATALOG.md), [Room 2.8.4](https://developer.android.com/jetpack/androidx/releases/room#2.8.4) | Room хранит метаданные и доступность; PhotoStore владеет приватными файлами | Собственная реализация `catalog/`, `gallery/DeviceMediaQuery.kt`; upstream-код не копировался. Room 2.8.4 и KSP 2.3.9 — зависимости Apache-2.0, не модели. SHA-ID импортов сохранены; device identity учитывает volume/version/row/generation. Схема v1 экспортирована в `app/schemas/`; incremental scan/Paging ещё не реализованы |
