...
| --- | --- | --- |
| [Дизайн ленты и Fold](docs/superpowers/specs/2026-09-08-gallery-zoom-fold-design.md) | Мозаика дней, пять уровней масштаба времени и нижняя навигация | Реализовано собственным кодом: лента перестраивается по дате съёмки с переходами Фото → Дни → Недели → Месяцы → Годы; сторонний код не переносился |
